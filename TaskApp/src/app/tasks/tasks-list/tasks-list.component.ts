...
export class TasksListComponent {
  //private tasksService = inject(TaskService);   //inject TaskService
  private tasksService = inject(TasksServiceToken);   //inject TaskService

  private selectedFilter = signal<string>('all');
  tasks = computed(()=>{       //shows particular selected status data
